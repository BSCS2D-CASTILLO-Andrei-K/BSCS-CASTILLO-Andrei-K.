...
const productPrices = {
    PR1: 1299, PR2: 1199, PR3: 1199, PR4: 1299, PR5: 1299,
    PR6: 1299, PR7: 999, PR8: 999,  
};
...
// Place the order and show details 
function orderAllItems() {
    ...
    document.getElementById('receiptDetails').innerText = orderDetails || 'No products selected!';
